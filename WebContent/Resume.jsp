...
$(function(){
	...
	$("#dg").datagrid({
		...
		columns:[[
			...
			{field:"dename",title:"部门名称",width:100,align:"center"},
			...
			{field:"result",title:"业绩",width:100,align:"center"},
...
function update(){
    ...
    $("#ff").form("reset");
  	//修改记录的请求地址
	url = "rupdate?id="+array[0].id;
	//表单填充内容
    //表单填充内容
  	$.ajax({
  		url:"rqueryById?id="+array[0].id,
  		type:"post",
  		dataType:"json",
  		success:function(result){
  			$("#ff").form("load",result);
		...
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				...
				<tr>
					...
					<td><input type="text" name="orgname" class="easyui-textbox" data-options="required:true"></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="right">业绩：</td>
					<td><input type="text" name="result" class="easyui-textbox" data-options="required:true"></td>
				</tr>
				<tr>
					<td class="right">开始时间：</td>
					<td><input type="date" name="beginDate" class="easyui-datebox" data-options="required:true"></td>
				</tr>
				<tr>
					<td class="right">结束时间：</td>
					<td><input type="date" name="endDate" class="easyui-datebox" data-options="required:true,editable:false"></td>
				</tr>
			</table>
		</form>
	</div>
