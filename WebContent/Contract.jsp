...
$(function(){
	...
	$("#dg").datagrid({
		...
		columns:[[
			...
			{field:"attachment",title:"合同的电子文档",width:100,align:"center"}
		]],
		fitColumns:true,
		toolbar: [{
			text:"新增",
...
function update(){
    ...
    $("#ff").form("reset");
  	//修改记录的请求地址
	url = "cupdate?id="+array[0].id;
	//表单填充内容
  	$.ajax({
  		url:"cqueryById?id="+array[0].id,
  		type:"post",
  		dataType:"json",
  		success:function(result){
  			$("#ff").form("load",result);
	...
	<div id="dd" class="easyui-dialog" style="width: 400px;text-align: center;padding: 10px;" closed="true">
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				...
				<tr>
					<td class="right">合同的电子文档：</td>
					<td><input type="text" name="attachment" class="easyui-textbox" data-options="required:true"></td>
				</tr>
			</table>
		</form>
	</div>
