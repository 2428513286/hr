...
$(function(){
	...
	$("#dg").datagrid({
		...
		columns:[[
			...
			{field:"offceNo",title:"部门办公室编号",width:100,align:"center"},
			{field:"phone",title:"部门电话",width:100,align:"center"},
			{field:"remark",title:"部门说明",width:100,align:"center"},
		]],
		fitColumns:true,
		toolbar: [{
			text:"新增",
...
<body>
	<div style="height: 5%">
		<form name="searchform" method="post" id ="searchform">
			编号：<input type="text" name="qusername" class="easyui-textbox" >
			部门名称：<input type="text" name="qname" class="easyui-textbox">
		...
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				...
				<tr>
					...
					<td><input type="text" name="offceNo" class="easyui-textbox" data-options="required:true"></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="right">部门说明：</td>
					<td><input type="text" name="remark" class="easyui-textbox" data-options="required:true,editable:false"></td>
				</tr>
			</table>
		</form>
	</div>
