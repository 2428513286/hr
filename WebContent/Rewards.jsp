...
$(function(){
	...
	$("#dg").datagrid({
		...
		columns:[[
			...
			{field:"title",title:"奖惩标题",width:100,align:"center"},
			{field:"content",title:"奖惩内容",width:100,align:"center"},
			{field:"type",title:"奖惩类别",width:100,align:"center"},
			{field:"createDate",title:"奖惩时间",width:100,align:"center"}
		]],
		fitColumns:true,
		toolbar: [{
			text:"新增",
...
function update(){
    ...
    $("#ff").form("reset");
  	//修改记录的请求地址
	url = "rsupdate?id="+array[0].id;
	//表单填充内容
  	$.ajax({
  		url:"rsqueryById?id="+array[0].id,
  		type:"post",
  		dataType:"json",
  		success:function(result){
  			$("#ff").form("load",result);
	...
	<div id="dd" class="easyui-dialog" style="width: 400px;text-align: center;padding: 10px;" closed="true">
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				...
				<tr>
					<td class="right">奖惩标题：</td>
					<td><input type="text" name="title" class="easyui-textbox" data-options="required:true"></td>
				</tr>
				<tr>
					<td class="right">奖惩内容：</td>
					<td><input type="text" name="content" class="easyui-textbox" data-options="required:true"></td>
				</tr>
				<tr>
					<td class="right">奖惩类别：</td>
					<td><input type="text" name="type" class="easyui-numberbox" data-options="required:true"></td>
				</tr>
				<tr>
					<td class="right">奖惩时间：</td>
					<td><input type="date" name="createDate" class="easyui-datebox" data-options="required:true"></td>
				</tr>
			</table>
		</form>
	</div>
