...
$(function(){
	...
	$("#dg").datagrid({
		...
		columns:[[
			...
			{field:"createTime",title:"入职时间",width:100,align:"center"}
		]],
		fitColumns:true,
		toolbar: [{
			text:"新增",
...
function update(){
	...
	$.ajax({
		url:"empqueryById?id="+array[0].id,
		type:"post",
		dataType:"json",
		success:function(result){
			$("#ff").form("load",result);
	...
	<div id="dd" class="easyui-dialog" style="width: 400px;text-align: center;padding: 10px;" closed="true">
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				...
				<tr>
					<td class="right">部门ID：</td>
					<td>
						<select id="de" name="deptid" style="width: 170px">
						</select>
					</td>
				</tr>
				<tr>
